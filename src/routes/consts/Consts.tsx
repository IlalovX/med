...
import {
  ...
  getRouteContactInfoSimulationCenter,
  getRouteContacts,
  ...
  getRoutePackageAcceptedDocumentsClinic,
...
export const PathNames: Record<PathEnums, string> = {
  ...
  [PathEnums.CONTACT_INFO_SIMULATION_CENTER]:
    getRouteContactInfoSimulationCenter(),
  ...
  [PathEnums.PACKAGE_ACCEPTED_DOCUMENTS_CLINIC]:
    getRoutePackageAcceptedDocumentsClinic(),
  ...
  [PathEnums.ADMISSION_PROCEDURE_CLINIC]: getRouteAdmissionProcedure(),
  ...
  [PathEnums.CLASS_SCHEDULE]: getRouteClassScheduleInter(),
