...
function Footer() {
  return (
    <div className=" bg-black p-5 text-white">
      <section className="container mx-auto flex sm:space-x-32 ">
        <img src={Logo} className="h-[82px]" />
        <div className="lg:flex gap-x-16 hidden">
      ...
      <section className="hidden sm:block border-t-2 border-white mt-5 py-5">
