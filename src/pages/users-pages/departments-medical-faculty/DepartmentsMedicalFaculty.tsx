    ...
    <div className="bg-almost-blue text-white p-5 ">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 gap-10">
          <NavLink
            to={`/about_department_medical_faculty/gynecology`}
          ...
          <NavLink
            to={`/about_department_medical_faculty/surgical_diseases`}
            className="relative border border-white rounded-lg p-5  h-52"
          >
          ...
          <NavLink
            to={`/about_department_medical_faculty/hematology`}
            className="relative border border-white rounded-lg p-5  h-52"
          >
          ...
          <NavLink
            to={`/about_department_medical_faculty/phthisiatry`}
            className="relative border border-white rounded-lg p-5  h-52"
          >
          ...
          <NavLink
            to={`/about_department_medical_faculty/pediatrics`}
            className="relative border border-white rounded-lg p-5  h-52"
          >
...
export default DepartmentsMedicalFaculty;
